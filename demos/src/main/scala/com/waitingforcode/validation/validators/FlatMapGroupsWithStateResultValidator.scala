...
import com.waitingforcode.stateful.{FlatMapGroupsWithStateStatefulAppConfig, UserClicks}

object FlatMapGroupsWithStateResultValidator extends ResultValidator[UserClicks] {
  override val inputDir: String = FlatMapGroupsWithStateStatefulAppConfig.outputDir
